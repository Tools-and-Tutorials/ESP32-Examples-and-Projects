...
/********************* ILI9341: Steps before compile****************
 * 1. Update User_Setup.h
 *    a. Uncomment #define TOUCH_CS, (change pin number if required)
 *    b. Uncomment following lines
 *        #define TFT_MISO
 *        #define TFT_MOSI
 *        #define TFT_SCLK
 *        #define TFT_CS  
...
void setup(void)
{
  ...
  Serial.println("Calibrate screen");
  touchCalibrate();
